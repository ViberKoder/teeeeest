...
| `ADMIN_MNEMONIC`                     | Фраза кошелька-админа (для on-chain root updates), если нет `ADMIN_PRIVATE_KEY_HEX`.                            |
| `ADMIN_PRIVATE_KEY_HEX`              | (Опц.) Ed25519 в hex: **64** символа = 32-byte seed, **128** = 64-byte secret. Имеет приоритет над мнемоникой.  |
