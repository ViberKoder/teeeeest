 ...
 * `jetton-metadata.json` → … → `jetton-metadata4.json` → `jetton-metadata5.json`.
 */
export const JETTON_METADATA_FILENAME = 'jetton-metadata5.json';

/** Previous fixed URLs — still served (same JSON) for in-flight indexers. */
export const JETTON_METADATA_FILENAME_LEGACY4 = 'jetton-metadata4.json';
