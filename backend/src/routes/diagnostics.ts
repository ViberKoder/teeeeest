  ...
  app.get('/api/v1/diagnostics', async () => {
    ...
    return {
      ...
      how_balance_works: [
        ...
        'For MyTonWallet: point metadata custom_payload_api_uri to /api/v2/jettons/{master} to bust proxy cache; attach ≥0.18 TON for claim + external recipient deploy (Proof API transfer_hints.attach_ton_external).',
